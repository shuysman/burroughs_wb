...
writeRaster(aet_2022, filename = "raster/baseline_aet_2002-2022.tif")
writeRaster(cwd_2022, filename = "raster/baseline_cwd_2002-2022.tif")
...
aet_warm_wet <- load_gcm_mean(file.path(proj_dir, "MRI-CGCM3_rcp85_AET_annual_sum_burroughs.nc"))
cwd_warm_wet <- load_gcm_mean(file.path(proj_dir, "MRI-CGCM3_rcp85_Deficit_annual_sum_burroughs.nc"))

aet_hot_wet <- load_gcm_mean(file.path(proj_dir, "CanESM2_rcp85_AET_annual_sum_burroughs.nc")) 
cwd_hot_wet <- load_gcm_mean(file.path(proj_dir, "CanESM2_rcp85_Deficit_annual_sum_burroughs.nc"))

aet_warm_dry <- load_gcm_mean(file.path(proj_dir, "MRI-CGCM3_rcp45_AET_annual_sum_burroughs.nc"))
cwd_warm_dry <- load_gcm_mean(file.path(proj_dir, "MRI-CGCM3_rcp45_Deficit_annual_sum_burroughs.nc"))

aet_hot_dry <- load_gcm_mean(file.path(proj_dir, "HadGEM2-CC365_rcp85_AET_annual_sum_burroughs.nc"))
cwd_hot_dry <- load_gcm_mean(file.path(proj_dir, "HadGEM2-CC365_rcp85_Deficit_annual_sum_burroughs.nc"))

aet_warm_wet_sd <- load_gcm_sd(file.path(proj_dir, "MRI-CGCM3_rcp85_AET_annual_sum_burroughs.nc"))
cwd_warm_wet_sd <- load_gcm_sd(file.path(proj_dir, "MRI-CGCM3_rcp85_Deficit_annual_sum_burroughs.nc"))

aet_hot_wet_sd <- load_gcm_sd(file.path(proj_dir, "CanESM2_rcp85_AET_annual_sum_burroughs.nc")) 
cwd_hot_wet_sd <- load_gcm_sd(file.path(proj_dir, "CanESM2_rcp85_Deficit_annual_sum_burroughs.nc"))

aet_warm_dry_sd <- load_gcm_sd(file.path(proj_dir, "MRI-CGCM3_rcp45_AET_annual_sum_burroughs.nc"))
cwd_warm_dry_sd <- load_gcm_sd(file.path(proj_dir, "MRI-CGCM3_rcp45_Deficit_annual_sum_burroughs.nc"))

aet_hot_dry_sd <- load_gcm_sd(file.path(proj_dir, "HadGEM2-CC365_rcp85_AET_annual_sum_burroughs.nc"))
cwd_hot_dry_sd <- load_gcm_sd(file.path(proj_dir, "HadGEM2-CC365_rcp85_Deficit_annual_sum_burroughs.nc"))


## Worst Case Scenarios
writeRaster(aet_hot_wet, "raster/aet_hot_wet.tif")
writeRaster(cwd_hot_dry, "raster/cwd_hot_dry.tif")
...
writeRaster(aet_hot_wet_change, "raster/aet_hot_wet_change.tif")
writeRaster(cwd_hot_dry_change, "raster/cwd_hot_dry_change.tif")
...
``` {r, projections-sd-aet, warning = FALSE, message = FALSE, echo = FALSE, fig.height = 16, fig.width = 16, out.width = '100%', fig.cap = "AET Interannual variability (standard deviation) in climatic conditions under projections from selected GCMs representing hot/wet, hot/dry, warm/wet, and warm/dry conditions"}
...
``` {r, projections-sd-cwd, warning = FALSE, message = FALSE, echo = FALSE, fig.height = 16, fig.width = 16, out.width = '100%', fig.cap = "CWD Interannual variability (standard deviation) in climatic conditions under projections from selected GCMs representing hot/wet, hot/dry, warm/wet, and warm/dry conditions"}
...
``` {r, best-plantings-setup, warning = FALSE, echo = FALSE, message = FALSE}
...
writeRaster(best_sites_historical, "raster/selected_sites_historical.tif")
writeRaster(best_sites_hot_dry, "raster/selected_sites_hot_dry.tif")
writeRaster(best_sites_hot_wet, "raster/selected_sites_hot_wet.tif")
...
``` {r best-plantings-historical, warning = FALSE, message = FALSE, echo = FALSE, fig.height = 10, fig.width = 10, fig.cap = "Locations that maximize AET and CWD for historical (2002-2022). n = number of pixels selected by algorithm, percentage shown is percentage of landscape identified by algorithm."}

best_sites_historical_plot

```

``` {r best-plantings-projections, warning = FALSE, message = FALSE, echo = FALSE, fig.height = 16, fig.width = 16, fig.cap = "Locations that maximize AET and CWD for RCP4.5/RCP8.5 end-of-century projection ensembles. n = number of pixels selected by algorithm, percentage shown is percentage of landscape identified by algorithm."}
