...
highest_aet <- selectHighest(aet_mean_2022, n = n_sites)
lowest_cwd <- selectHighest(cwd_mean_2022, n = n_sites, low = TRUE)
...
(mean_aet <- global(mask(aet_mean_2022, highest_aet), fun = "mean", na.rm = TRUE))
(mean_cwd <- global(mask(cwd_mean_2022, lowest_cwd), fun = "mean", na.rm = TRUE))
