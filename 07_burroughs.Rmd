...
water balance for the Burroughs Creek site (Figure \@ref(fig:planting-units)) in Shoshone National
...
minimize drought stress and fire
risk[@thomaWaterBalanceIndicator2020].  Depending on management
objects, optimal site characteristics can vary and these results can
be interpreted in different ways.  For example, if management goals
are to:
...
Figures displayed in this document can be clicked to enlarged.
